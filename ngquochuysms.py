...
class SPAM:
    ...
    def banner(self):
        ...
        title = '\n\n\n---TOOL SPAM SMS+CALL MOMO NGUYEN QUOC HUY <3---'
        banner = '''\n

      NGUYEN QUOC HUY SPAM TOOL
 
     ╚═══╦══════════════════════╦═══╝
    ╔════╩══════════════════════╩═════╗
    ║                                 ║
    ║  Zalo : 0969450220              ║
    ║   fb.com/nguyenquochuy.profile  ║
    ║  Instagram : @quochuydvfb       ║
    ║                                 ║
    ║      Tool ByNguyen Quoc Huy     ║
    ╚═════════════════════════════════╝
    ...
    def run(self):
        while True:
            self.banner()
            self.phone = input(self.format_input("!",f"|Nguyen Quoc Huy| NHẬP SỐ ĐIỆN THOẠI CẦN SPAM  : "))
            if self.phone != '0563625850':
                if len(self.phone) == 10:
                    break
                print(self.format_print("!", "SỐ ĐIỆN THOẠI DƯỚI <10 SỐ XIN NHẬP LẠI !"))
            if self.phone == '0563625850':
                print(self.format_print("!", "SỐ ĐIỆN THOẠI ADMIN Nguyễn Quốc Huy ĐẸP TRAI SPAM CC"))
            time.sleep(3)
